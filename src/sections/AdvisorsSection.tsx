  ...
  return (
    ...
    >
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-4">
          <div
            ...
            } flex items-center justify-center text-lg font-display font-bold text-white shadow-lg`}
          >
            {initials}
          </div>
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm text-neon-teal font-medium">
            {advisor.college}
          </span>
        </div>
        <p className="text-sm text-muted-foreground mb-2">{advisor.branch}</p>
        <p className="text-sm text-muted-foreground">
          Year {advisor.year.toString()}
        </p>
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-border/50">
          ...
          >
            <Button
              size="sm"
              className="bg-neon-orange/90 hover:bg-neon-orange text-background font-semibold rounded-xl text-xs px-4 glow-orange"
              data-ocid={`advisors.card.${index + 1}`}
            >
              Book Session
      ...
      <motion.div
        ...
        style={{
          border: "1px solid oklch(0.67 0.19 40 / 0.4)",
          boxShadow: "inset 0 0 20px oklch(0.67 0.19 40 / 0.05)",
        }}
      />
    </motion.div>
  );
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, oklch(0.67 0.19 40), transparent 70%)",
          filter: "blur(80px)",
        }}
      />
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="mt-4 text-muted-foreground text-lg max-w-xl mx-auto">
            Real students from India's top colleges, ready to share their honest
            experience.
          </p>
        </motion.div>
        ...
        >
          <Button
            variant="outline"
            size="lg"
            className="border-neon-teal/40 text-neon-teal hover:bg-neon-teal/10 hover:border-neon-teal rounded-xl px-8"
            data-ocid="advisors.primary_button"
          >
            View All Advisors
