...
export default function Advisors({
  ...
  // let the parent decide how many cards to show, etc.
  useEffect(() => {
    onFiltered(filtered);
  }, [filtered, onFiltered]);
  ...
  return (
    <div className="text-center mb-10">
      ...
      >
        Find Your <span className="gradient-text-orange">Advisor</span>
      </motion.h3>
      ...
      >
        Search by college or branch, then refine with quick filters.
      </motion.p>
